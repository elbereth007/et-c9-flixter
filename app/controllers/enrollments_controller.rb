...
# next line added 28 jun 17 so action to take money not started for free course (lesson 29)
...
# next line moved here 28 jun 17 to prevent users with declined payments to still have access to lessons (lesson 29)
  current_user.enrollments.create(course: current_course)
